...
def medojed(vypis=True):
    ...
    try:
        ...
        print("Chybí některý z konfiguračních souborů. Viz následující chybové hlášení a soubor README.md.")
        print(e)
        quit()
    ...
    with open(os.path.join("data",f"{int(time.time())}.json"), 'w+', encoding="utf-8") as f:
